...
import { Moon, Sun } from "lucide-react"; // optional icons (install with: npm i lucide-react)
...
const ToggleButton = ({ theme, toggleTheme }) => {
  return (
    <label
      className="flex cursor-pointer items-center gap-2 px-3 py-2 rounded-full bg-base-200 hover:bg-base-300 transition-colors"
    >
      {/* Sun icon (light mode) */}
      <Sun
